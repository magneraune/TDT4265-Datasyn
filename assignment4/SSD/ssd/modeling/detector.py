...
from ssd.modeling.backbone.basic import BasicModel, BasicModel_improved, BasicModel_max_improved 
...
def build_backbone(cfg):
    ...
    if backbone_name == "basic_improved":
        model = BasicModel_improved(cfg)
        return model
    if backbone_name == "basic_max_improved":
        model = BasicModel_max_improved(cfg)
        return model
