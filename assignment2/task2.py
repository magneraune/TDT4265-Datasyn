...
class SoftmaxTrainer(BaseTrainer):
    ...
    def train_step(self, X_batch: np.ndarray, Y_batch: np.ndarray):
        ...
        for l in range(len(self.model.ws)):
            if self.use_momentum and self.model.grads_prev[l] is not None:
                self.model.ws[l] -= self.learning_rate*(self.model.grads[l]+self.momentum_gamma*self.model.grads_prev[l])
            else:
                self.model.ws[l] -= self.learning_rate*self.model.grads[l]
